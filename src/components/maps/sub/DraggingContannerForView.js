...
const DraggingContannerForView = (props) => {
  ...
  return (
    <div style={{ width: "calc(100vw - 15px)", height: "calc(100vh - 15px)" }}>
      <div
        className={`relative overflow-auto bg-transparent flex justify-center items-center w-full h-full`}
        // w-screen - 64px
        // style={{ width: "calc(100vw - 15px)", height: "calc(100vh - 15px)" }}
      >
        <div
          ref={containerRef}
          className={`overflow-auto bg-transparent cursor-grab w-full h-full`}
          // style={{ width: "calc(100vw - 15px)", height: "calc(100vh - 15px)" }}
        >
...
export default DraggingContannerForView;
